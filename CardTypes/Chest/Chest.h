...
public:
    // Constructor using initializer list (Design Criterion 8 - DC8)
    ...
    // Marked as const since it doesn’t modify the object (DC7)
    ...
    // Marked as const because it doesn't modify the Chest card itself (DC7)
